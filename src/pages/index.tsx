  ...
  return (
    <div className="flex flex-col w-full items-center">
      ...
      <main className="flex flex-col w-full items-center p-0">
        <h1 className={`f-100 font-bold fc-black ${styles.fs_big}`}>
          {" "}
          LEARN & CODE{" "}
        </h1>
        ...
        <div className="flex w-9/12 justify-center">
          <div className="flex w-50 flex-col items-top">
            <p className={`fc-black ${styles.para}`}>
              A coding platform where you can compete with fellow coders,
              friends and random people to learn and improve your coding skills.
              You can showcase your codeforces profile in an amazing dashboard
              powered by canonforces.
            </p>
